...
@{
  ...
  FileList = @('.\data\appicon.ico','.\data\banner.ps1','.\docs\pstools.daikin.md','.\include\module.utility.functions.ps1','.\private\Convert-DaikinResponse.ps1','.\private\Get-DaikinBasicInfo.ps1','.\private\Get-DaikinControlInfo.ps1','.\private\Get-DaikinModelInfo.ps1','.\private\Get-DaikinPollingConfiguration.ps1','.\private\Get-DaikinSensorInfo.ps1','.\private\Get-DaikinWeekStats.ps1','.\private\Get-DaikinYearStats.ps1','.\private\Resolve-DaikinHostname.ps1','.\private\Test-DaikinConnectivity.ps1','.\public\Get-DaikinStatus.ps1','.\public\Set-DaikinAirCon.ps1','.\settings\config.json','.\LICENSE.txt','.\pstools.daikin.psd1','.\pstools.daikin.psm1')
  PrivateData = @{
